...
\href{http://cran.r-project.org/web/packages/caTools/index.html}{\pkg{caTools}}\texttt{::}\mxkwd{LogitBoost}  && {\tt \Sexpr{'predict(obj, type =  "raw", nIter)'}} \\
\hline \\
\\
\end{tabular}
\end{center}
...
mod_pkgs <- mod_pkgs[mod_pkgs != "terac"]
@
